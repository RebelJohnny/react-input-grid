    ...
    <>
      <div className="row align-items-center">
        ...
        <div className="content col-lg-12 col-12">
          <div
            className={`table-responsive sticky-h-f gridRow ${
        ...
        <div className="content col-lg-12 col-md-12 col-12">
          {fieldArrayErrors?.map((error, index) => (
            <p className="error-msg" key={index}>
              {error
                ? ` ${t("ردیف")} ${index + 1} : ${CreateTableError(error)}`
                : null}
            </p>
          ))}
        </div>
...
export { default as InputGridDeleteRowBtn } from "./Components/InputGridDeleteRowBtn";
